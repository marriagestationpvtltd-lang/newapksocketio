...
$displayNameBase = trim((string) pathinfo($originalName, PATHINFO_FILENAME));
$displayNameBase = preg_replace('/[^\w\- ]+/u', '_', $displayNameBase) ?: 'custom-tone';
$displayName = $displayNameBase . '.' . $extension;
